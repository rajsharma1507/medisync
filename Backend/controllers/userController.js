// api logic for the user like login , register , get profile , update profile , payment gateways
...
const registerUser = async (req, res) => {
  try {
    ...
    //hashing user password means encrpyt the password
